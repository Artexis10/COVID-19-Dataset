...
.then(countries => {
    var asia_data = [[],[],[],[]];
    var africa_data = [[],[],[],[]];
    var australia_oceania_data = [[],[],[],[]];
    var europe_data = [[],[],[],[]];
    var north_america_data = [[],[],[],[]];
    var south_america_data = [[],[],[],[]];
    for (i = 0; i < countries.length; i++) {
        switch (countries[i].continent) {
            case 'Asia':
                asia_data[0].push(countries[i].country);
                asia_data[1].push(countries[i].cases);
                asia_data[2].push(countries[i].deaths);
                asia_data[3].push(countries[i].recovered);
                break;
            case 'Africa':
                africa_data[0].push(countries[i].country);
                africa_data[1].push(countries[i].cases);
                africa_data[2].push(countries[i].deaths);
                africa_data[3].push(countries[i].recovered);
                break;
            case 'Australia/Oceania':
                australia_oceania_data[0].push(countries[i].country);
                australia_oceania_data[1].push(countries[i].cases);
                australia_oceania_data[2].push(countries[i].deaths);
                australia_oceania_data[3].push(countries[i].recovered);
                break;
            case 'Europe':
                europe_data[0].push(countries[i].country);
                europe_data[1].push(countries[i].cases);
                europe_data[2].push(countries[i].deaths);
                europe_data[3].push(countries[i].recovered);
                break;
            case 'North America':
                north_america_data[0].push(countries[i].country);
                north_america_data[1].push(countries[i].cases);
                north_america_data[2].push(countries[i].deaths);
                north_america_data[3].push(countries[i].recovered);
                break;
            case 'South America':
                south_america_data[0].push(countries[i].country);
                south_america_data[1].push(countries[i].cases);
                south_america_data[2].push(countries[i].deaths);
                south_america_data[3].push(countries[i].recovered);
                break;
        }
    }

    var ctx = document.getElementById('asiaChart').getContext('2d');
    var asiaChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: asia_data[0],
            datasets: [{
    ...
    var ctx = document.getElementById('africaChart').getContext('2d');
    var africaChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: africa_data[0],
            datasets: [{
                label: 'Infected',
                data: africa_data[1],
                backgroundColor: 'rgba(255, 0, 0, 0.6)',
                ...
                label: 'Recovered',
                data: africa_data[3],
                backgroundColor: 'rgba(0, 149, 0, 0.6)',
                borderColor: 'rgba(0, 149, 0, 0.7)',
                borderWidth: 2
            }]
        },
        options: {
    ...
    var ctx = document.getElementById('australiaOceaniaChart').getContext('2d');
    var australiaOceaniaChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: australia_oceania_data[0],
            datasets: [{
                label: 'Infected',
                data: australia_oceania_data[1],
                backgroundColor: 'rgba(255, 0, 0, 0.6)',
                borderColor: 'rgba(255, 0, 0, 0.7)',
                borderWidth: 2,
            }, {
                label: 'Deaths',
                data: australia_oceania_data[2],
                backgroundColor: 'rgba(0, 0, 0, 0.6)',
                borderColor: 'rgba(0, 0, 0, 0.7)',
                borderWidth: 2
            }, {
                label: 'Recovered',
                data: australia_oceania_data[3],
                backgroundColor: 'rgba(0, 0, 255, 0.6)',
                borderColor: 'rgba(0, 0, 255, 0.7)',
                borderWidth: 2
            }]
    ...
    var ctx = document.getElementById('northAmericaChart').getContext('2d');
    var northAmericaChart = new Chart(ctx, {
        ...
        data: {
            ...
            labels: north_america_data[0],
            datasets: [{
                label: 'Infected',
                data: north_america_data[1],
                backgroundColor: 'rgba(255, 0, 0, 0.6)',
                borderColor: 'rgba(255, 0, 0, 0.7)',
                borderWidth: 2,
            }, {
                label: 'Deaths',
                data: north_america_data[2],
                backgroundColor: 'rgba(0, 0, 0, 0.6)',
                borderColor: 'rgba(0, 0, 0, 0.7)',
                borderWidth: 2
            }, {
                label: 'Recovered',
                data: north_america_data[3],
                backgroundColor: 'rgba(0, 0, 255, 0.6)',
                borderColor: 'rgba(0, 0, 255, 0.7)',
                borderWidth: 2
            }]
    ...
    var ctx = document.getElementById('southAmericaChart').getContext('2d');
    var southAmericaChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: south_america_data[0],
            datasets: [{
                label: 'Infected',
                data: south_america_data[1],
                backgroundColor: 'rgba(255, 0, 0, 0.6)',
                borderColor: 'rgba(255, 0, 0, 0.7)',
                borderWidth: 2,
            }, {
                label: 'Deaths',
                data: south_america_data[2],
                backgroundColor: 'rgba(0, 0, 0, 0.6)',
                borderColor: 'rgba(0, 0, 0, 0.7)',
                borderWidth: 2
            }, {
                label: 'Recovered',
                data: south_america_data[3],
                backgroundColor: 'rgba(0, 149, 0, 0.6)',
                borderColor: 'rgba(0, 149, 0, 0.7)',
                borderWidth: 2
            }]
...
.then(continents => {
    ...
    for (i = 0; i < continents.length; i++) {
        continents_arr.push(continents[i]);
    }
    ...
    for (i = 0; i < continents_arr.length; i++) {
        var data_reference = [continents_arr[i].cases, continents_arr[i].deaths,    continents_arr[i].recovered];
        continents_labels.push(continents_arr[i].continent);
        for (x = 0; x < continents_data.length; x++) {
            continents_data[x].push(data_reference[x]);
        }
    }

    var ctx = document.getElementById('continentsChart').getContext('2d');
    var continentsChart = new Chart(ctx, {
        type: 'horizontalBar',
        data: {
            labels: continents_labels,
            datasets: [{
                label: 'Infected',
                data: continents_data[0],
                backgroundColor: 'rgba(255, 0, 0, 0.6)',
                borderColor: 'rgba(255, 0, 0, 0.7)',
                borderWidth: 2
            }, {
                label: 'Deaths',
                data: continents_data[1],
                backgroundColor: 'rgba(0, 0, 0, 0.6)',
                borderColor: 'rgba(0, 0, 0, 0.7)',
                borderWidth: 2
            }, {
                label: 'Recovered',
                data: continents_data[2],
                backgroundColor: 'rgba(0, 0, 255, 0.6)',
...
.then(timeline => {
    ...
    for (i = 0; i < timeline.length; i++) {
        dates.push(new Date(timeline[i].last_update));
        console.log(new Date(timeline[i].last_update));
        data[0].push(timeline[i].total_cases);
        data[1].push(timeline[i].total_deaths);
        data[2].push(timeline[i].total_recovered);
    }
